...
export default function EditWhitepaperPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <AdminShell><div style={{ padding: "32px 40px", maxWidth: "900px" }}><h1 style={{ fontSize: "22px", fontWeight: 700, color: "#111", margin: "0 0 24px" }}>Edit Whitepaper</h1><ContentForm type="WHITEPAPER" postId={id} initial={post} /></div></AdminShell>;
}
