...
export default function EditBlogPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (notFound) return <AdminShell><div style={{ padding: 40 }}>Post not found.</div></AdminShell>;
  ...
  return (
    <AdminShell>
      <div style={{ padding: "32px 40px", maxWidth: "900px" }}>
        <h1 style={{ fontSize: "22px", fontWeight: 700, color: "#111", margin: "0 0 24px" }}>Edit Blog Post</h1>
        <ContentForm type="BLOG" postId={id} initial={post} />
      </div>
    </AdminShell>
  );
}
