...
description: Generates high-quality, predictable, and efficient skill directories based on user requirements. Use this skill whenever the user asks to create or generate a new skill.
---
